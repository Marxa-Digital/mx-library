...
@Component({
  selector: 'mx-slider-config',
  templateUrl: './mx-slider-config.component.html',
  styleUrls: ['./mx-slider-config.component.scss']
})
export class MxSliderConfigComponent implements OnInit {
